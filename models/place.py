...
class Place:
    ...
    def to_dict(self):
        """Convert place to dictionary. Serialization"""
        return {
            "id": self.__id,
    ...
    def from_dict(cls, data):
        """Convert dictionary to place. Deserialization"""
        place = cls(
            data["name"], data["description"], data["address"],
            data["latitude"], data["longitude"], data["city_id"],
        ...
        place.reviews = [Review.from_dict(review)
                         for review in data["reviews"]]
        place.amenities = [Amenity.from_dict(amenity)
